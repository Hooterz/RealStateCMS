...
abstract class PropertyQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \RealStateModel\Base\PropertyQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'RealState', $modelName = '\\RealStateModel\\Property', $modelAlias = null)
    {
    ...
    {
        if ($location instanceof \RealStateModel\Location) {
            return $this
            ...
            throw new PropelException('filterByLocation() only accepts arguments of type \RealStateModel\Location or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \RealStateModel\LocationQuery A secondary query class using the current class as primary query
     */
    public function useLocationQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinLocation($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Location', '\RealStateModel\LocationQuery');
    }

    /**
     * Use the Location relation Location object
     *
     * @param callable(\RealStateModel\LocationQuery):\RealStateModel\LocationQuery $callable A function working on the related query
     *
     ...
     *
     * @return \RealStateModel\LocationQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \RealStateModel\LocationQuery The inner query object of the NOT EXISTS statement
     */
     ...
     *
     * @param \RealStateModel\PropertyFeature|ObjectCollection $propertyFeature the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPropertyQuery The current query, for fluid interface
     */
    ...
    {
        if ($propertyFeature instanceof \RealStateModel\PropertyFeature) {
            return $this
            ...
            throw new PropelException('filterByPropertyFeature() only accepts arguments of type \RealStateModel\PropertyFeature or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \RealStateModel\PropertyFeatureQuery A secondary query class using the current class as primary query
     */
    public function usePropertyFeatureQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PropertyFeature', '\RealStateModel\PropertyFeatureQuery');
    }

    /**
     * Use the PropertyFeature relation PropertyFeature object
     *
     * @param callable(\RealStateModel\PropertyFeatureQuery):\RealStateModel\PropertyFeatureQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string $typeOfExists Either ExistsCriterion::TYPE_EXISTS or ExistsCriterion::TYPE_NOT_EXISTS
     *
     * @return \RealStateModel\PropertyFeatureQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \RealStateModel\PropertyFeatureQuery The inner query object of the NOT EXISTS statement
     */
    ...
    /**
     * Filter the query by a related \RealStateModel\PropertyImage object
     *
     * @param \RealStateModel\PropertyImage|ObjectCollection $propertyImage the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPropertyQuery The current query, for fluid interface
     */
    ...
    {
        if ($propertyImage instanceof \RealStateModel\PropertyImage) {
            return $this
            ...
            throw new PropelException('filterByPropertyImage() only accepts arguments of type \RealStateModel\PropertyImage or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \RealStateModel\PropertyImageQuery A secondary query class using the current class as primary query
     */
    public function usePropertyImageQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PropertyImage', '\RealStateModel\PropertyImageQuery');
    }

    /**
     * Use the PropertyImage relation PropertyImage object
     *
     * @param callable(\RealStateModel\PropertyImageQuery):\RealStateModel\PropertyImageQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string $typeOfExists Either ExistsCriterion::TYPE_EXISTS or ExistsCriterion::TYPE_NOT_EXISTS
     *
     * @return \RealStateModel\PropertyImageQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \RealStateModel\PropertyImageQuery The inner query object of the NOT EXISTS statement
     */
