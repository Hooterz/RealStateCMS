 ...
 *
 * @method     ChildCategoryQuery leftJoinProperty($relationAlias = null) Adds a LEFT JOIN clause to the query using the Property relation
 * @method     ChildCategoryQuery rightJoinProperty($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Property relation
 * @method     ChildCategoryQuery innerJoinProperty($relationAlias = null) Adds a INNER JOIN clause to the query using the Property relation
 *
 * @method     ChildCategoryQuery joinWithProperty($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Property relation
 *
 * @method     ChildCategoryQuery leftJoinWithProperty() Adds a LEFT JOIN clause and with to the query using the Property relation
 * @method     ChildCategoryQuery rightJoinWithProperty() Adds a RIGHT JOIN clause and with to the query using the Property relation
 * @method     ChildCategoryQuery innerJoinWithProperty() Adds a INNER JOIN clause and with to the query using the Property relation
 *
 * @method     \RealStateModel\PropertyQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildCategory|null findOneByCatId(int $cat_id) Return the first ChildCategory filtered by the cat_id column
 * @method     ChildCategory|null findOneByCatName(string $cat_name) Return the first ChildCategory filtered by the cat_name column *
...
abstract class CategoryQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \RealStateModel\Base\CategoryQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'RealState', $modelName = '\\RealStateModel\\Category', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT cat_id, cat_name FROM Category WHERE cat_id = :p0';
        try {
     ...
     *
     * @param \RealStateModel\Property|ObjectCollection $property the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByProperty($property, $comparison = null)
    {
        if ($property instanceof \RealStateModel\Property) {
            return $this
                ->addUsingAlias(CategoryTableMap::COL_CAT_ID, $property->getPropIshidden(), $comparison);
