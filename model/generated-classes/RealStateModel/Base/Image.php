...
use RealStateModel\Map\ImageTableMap;
...
abstract class Image implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\RealStateModel\\Map\\ImageTableMap';
    ...
    /**
     * Initializes internal state of RealStateModel\Base\Image object.
     */
     ...
     * @return $this|\RealStateModel\Image The current object (for fluent API support)
     */
    public function setImgId($v)
    {
        ...
        if ($this->img_id !== $v) {
            $this->img_id = $v;
            $this->modifiedColumns[ImageTableMap::COL_IMG_ID] = true;
        }
    ...
    public function setImgPath($v)
    {
        ...
        if ($this->img_path !== $v) {
            $this->img_path = $v;
            $this->modifiedColumns[ImageTableMap::COL_IMG_PATH] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ImageTableMap::translateFieldName('ImgId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->img_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ImageTableMap::translateFieldName('ImgPath', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ImageTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\RealStateModel\\Image'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ImageTableMap::COL_IMG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'img_id';
        }
        if ($this->isColumnModified(ImageTableMap::COL_IMG_PATH)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getImgId(),
            $keys[1] => $this->getImgPath(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\RealStateModel\Image
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setImgId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setImgPath($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\RealStateModel\Image The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ImageTableMap::COL_IMG_ID)) {
            $criteria->add(ImageTableMap::COL_IMG_ID, $this->img_id);
        }
        if ($this->isColumnModified(ImageTableMap::COL_IMG_PATH)) {
            $criteria->add(ImageTableMap::COL_IMG_PATH, $this->img_path);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \RealStateModel\Image (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setImgId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \RealStateModel\Image Clone of current object.
     * @throws PropelException
     */
    ...
    public function setPropertyImages(Collection $propertyImages, ConnectionInterface $con = null)
    {
        ...
        foreach ($propertyImagesToDelete as $propertyImageRemoved) {
            $propertyImageRemoved->setImage(null);
        }
     ...
     * @return ObjectCollection|ChildPropertyImage[] List of ChildPropertyImage objects
     */
    public function getPropertyImagesJoinProperty(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPropertyImageQuery::create(null, $criteria);
