 ...
 *
 * @method     \RealStateModel\PropertyQuery|\RealStateModel\FeatureQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PropertyFeatureQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \RealStateModel\Base\PropertyFeatureQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'RealState', $modelName = '\\RealStateModel\\PropertyFeature', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \RealStateModel\Feature object
     *
     * @param \RealStateModel\Feature|ObjectCollection $feature The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($feature instanceof \RealStateModel\Feature) {
            return $this
            ...
            throw new PropelException('filterByFeature() only accepts arguments of type \RealStateModel\Feature or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \RealStateModel\FeatureQuery A secondary query class using the current class as primary query
     */
    public function useFeatureQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinFeature($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Feature', '\RealStateModel\FeatureQuery');
    }

    /**
     * Use the Feature relation Feature object
     *
     * @param callable(\RealStateModel\FeatureQuery):\RealStateModel\FeatureQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string $typeOfExists Either ExistsCriterion::TYPE_EXISTS or ExistsCriterion::TYPE_NOT_EXISTS
     *
     * @return \RealStateModel\FeatureQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \RealStateModel\FeatureQuery The inner query object of the NOT EXISTS statement
     */
