...
use RealStateModel\PropertyImage;
use RealStateModel\PropertyImageQuery;
...
class PropertyImageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'RealStateModel.Map.PropertyImageTableMap';
     ...
     */
    const OM_CLASS = '\\RealStateModel\\PropertyImage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'RealStateModel.PropertyImage';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\RealStateModel\\PropertyImage');
  ...
  array (
    ...
    1 => ':prop_id',
        ...
        $this->addRelation('Image', '\\RealStateModel\\Image', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':propImg_img_id',
    1 => ':img_id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \RealStateModel\PropertyImage) { // it's a model object
