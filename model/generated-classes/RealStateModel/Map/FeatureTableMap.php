...
use RealStateModel\Feature;
use RealStateModel\FeatureQuery;
...
class FeatureTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'RealStateModel.Map.FeatureTableMap';
     ...
     */
    const OM_CLASS = '\\RealStateModel\\Feature';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'RealStateModel.Feature';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\RealStateModel\\Feature');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \RealStateModel\Feature) { // it's a model object
