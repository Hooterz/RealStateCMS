...
use RealStateModel\Property;
use RealStateModel\PropertyQuery;
...
class PropertyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'RealStateModel.Map.PropertyTableMap';
     ...
     */
    const OM_CLASS = '\\RealStateModel\\Property';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'RealStateModel.Property';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\RealStateModel\\Property');
    ...
    {
        $this->addRelation('Location', '\\RealStateModel\\Location', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':prop_location',
    1 => ':lo_id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \RealStateModel\Property) { // it's a model object
