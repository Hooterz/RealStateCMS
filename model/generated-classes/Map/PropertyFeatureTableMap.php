...
class PropertyFeatureTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.PropertyFeatureTableMap';
     ...
     */
    const OM_CLASS = '\\PropertyFeature';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropertyFeature';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PropertyFeature');
        $this->setPackage('');
  ...
  array (
    ...
    1 => ':prop_id',
        ...
        $this->addRelation('Feature', '\\Feature', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PropertyFeature) { // it's a model object
