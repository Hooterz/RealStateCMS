...
abstract class Feature implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\FeatureTableMap';
    ...
    /**
     * Initializes internal state of Base\Feature object.
     */
     ...
     * @return $this|\Feature The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Feature'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Feature The current object, for fluid interface
     */
    ...
    public function initPropertyFeatures($overrideExisting = true)
    {
        ...
        $this->collPropertyFeatures->setModel('\PropertyFeature');
    }
        ...
        if (null === $this->collPropertyFeatures || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collPropertyFeatures) {
                    ...
                    $collPropertyFeatures->setModel('\PropertyFeature');
