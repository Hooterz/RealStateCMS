...
use \PropertyImage as ChildPropertyImage;
...
abstract class Image implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ImageTableMap';
    ...
    /**
     * Initializes internal state of Base\Image object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Image'), 0, $e);
        }
    }
    ...
    public function initPropertyImages($overrideExisting = true)
    {
        ...
        $this->collPropertyImages->setModel('\PropertyImage');
    }
        ...
        if (null === $this->collPropertyImages || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collPropertyImages) {
                    ...
                    $collPropertyImages->setModel('\PropertyImage');
