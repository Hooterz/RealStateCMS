 ...
 *
 * @method     \PropertyQuery|\ImageQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PropertyImageQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\PropertyImageQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'RealState', $modelName = '\\PropertyImage', $modelAlias = null)
    {
     ...
     * Use the Image relation Image object
     *
     * @param callable(\ImageQuery):\ImageQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string $typeOfExists Either ExistsCriterion::TYPE_EXISTS or ExistsCriterion::TYPE_NOT_EXISTS
     *
     * @return \ImageQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \ImageQuery The inner query object of the NOT EXISTS statement
     */
